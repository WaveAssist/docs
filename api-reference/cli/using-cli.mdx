...
WaveAssist provides a command-line interface (CLI) for managing your projects and AI assistants directly from your terminal.
...
2. You can then use other commands like `push` and `pull` to manage your AI assistant code.
