...
The **Variables** section in WaveAssist allows you to manage key-value pairs and view AI assistant data directly from your dashboard. You can create, update, delete variables, and inspect associated data with ease.

[View variables in your project](https://app.waveassist.io/manage/variables)

## Managing Variables

Variables are reusable key-value pairs used across nodes and AI assistants. These values can be dynamically updated during execution or manually configured.
...
The **Data Viewer** allows you to inspect and manage the data used in your AI assistants. You can filter, view, and export data directly from the dashboard.
