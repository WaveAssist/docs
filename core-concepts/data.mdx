...
The **Data** section in WaveAssist allows you to manage variables and view data used in your workflows. You can create, update, and delete variables, as well as inspect and manage data directly from the dashboard.
