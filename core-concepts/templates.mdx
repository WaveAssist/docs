...
Check out our [Templates](https://waveassist.io/templates) for more information.
...
4. Click "Deploy with WaveAssist" to create a new project based on the template
5. Customize the configuration as needed

## Few Examples of Templates

WaveAssist offers several templates for different use cases:
...
Start using templates today! [Check out our templates](https://waveassist.io/templates).