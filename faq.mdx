...
<AccordionGroup>
  <Accordion icon="sparkles" title="What are WaveAssist Assistants?">
    Assistants are pre-configured, production-ready workflows that you can deploy instantly. They:
    - Come with best-practice implementations
  ...
  <Accordion icon="rocket" title="How do I get started with Assistants?">
    Getting started with Assistants is easy:
    - Browse our [Assistants gallery](https://waveassist.io/assistants)
    - Click "Deploy with WaveAssist" on your chosen assistant
  ...
  <Accordion icon="gear" title="Can I customize an Assistant?">
    ...
    - Customize the implementation to match your needs
  </Accordion>
</AccordionGroup>
