...
5. Go inside your project and view your keys from the keys section.
   <Frame caption="Create a New Project">
   	<img src="/images/your-keys.png" alt="Your Keys" />
   </Frame>
...
4. Paste the following code into the editor: _Dont forget to replace your uid in the code_
