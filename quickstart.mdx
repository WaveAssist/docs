---
title: "Quickstart"
description: "Deploy your first WaveAssist AI assistant in minutes with our step-by-step guide."
...
1. **Deploy an Assistant**: Get started instantly with our [pre-built assistants](/core-concepts/assistants) like [WavePredict](https://waveassist.io/assistants/wavepredict) for AI-powered PR reviews.
2. **Build from Scratch**: Follow this guide to create a simple AI assistant that generates a daily fortune.

---

## Option 1: Deploy an Assistant

1. Visit our [Assistants section](/core-concepts/assistants)
...
**Goal**: Create an AI assistant that:
...
Nodes are Python scripts that represent tasks in your AI assistant. Let's create a node to randomly select a fortune.
...
<Frame caption="AI Assistant Log Output">
...
To ensure your AI assistant runs every day at the scheduled time, you must deploy it.
...
2. Navigate to the **Deployments** section to verify that your AI assistant is successfully deployed.
   <Frame caption="Deployments">
   	<img src="/images/deployment.png" alt="Deployments" />
   </Frame>

Now your AI assistant will auto run every day as the cron schedule and print your fortune!🎉
...
Want to expand your AI assistant? Here are some ideas:
...
Check out the full guide: [Expand Your Fortune AI Assistant →](./whats-next)

<Card title="Expand Your Fortune AI Assistant" icon="arrow-right" href="./whats-next">
